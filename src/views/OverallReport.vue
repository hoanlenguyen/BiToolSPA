<template>
  ...
  <h5 class="subtitle is-6" >Total number of leads: <strong>{{totalLeads|formattedNumber}}</strong></h5>
  <h5 class="subtitle is-6" >Total number of data: <strong>{{totalData|formattedNumber}}</strong></h5>
    <b-field grouped class="">
      <div class="mr-3">
        <p class="subtitle is-6 mt-3">Total Points from</p>
      </div>
      <b-field>
